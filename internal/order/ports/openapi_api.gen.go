...
type ServerInterface interface {
	...
	// (POST /stripe/webhook)
	ProcessStripeEvent(ctx echo.Context) error
}
...
// ProcessStripeEvent converts echo context to params.
func (w *ServerInterfaceWrapper) ProcessStripeEvent(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.ProcessStripeEvent(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/stripe/webhook", wrapper.ProcessStripeEvent)
